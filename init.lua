...
minetest.register_on_dieplayer(function(player)
    ...
    if node.groups.lava ~= nil then
        minetest.chat_send_all(player_name .. " " .. S(get_message("lava")))
    -- Death by drowning
    elseif player:get_breath() == 0 then
        minetest.chat_send_all(player_name .. " " .. S(get_message("water")))
    -- Death by fire
    elseif node.name == "fire:basic_flame" then
        minetest.chat_send_all(player_name .. " " .. S(get_message("fire")))
    -- Death by something else
    else
        minetest.chat_send_all(player_name .. " " .. S(get_message("other")))
    end
